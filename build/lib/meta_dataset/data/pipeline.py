...
def process_episode(example_strings, class_ids, chunk_sizes, image_size,
  ...
  if query_decoder:
    ...
    if perform_filtration:
      ...
      unique_support_class_ids = tf.unique(support_class_ids)
      ...
      tf.print("xxxx", tf.map_fn(tf.math.logical_not, query_keep), query_class_ids_present_in_support_class_ids)
